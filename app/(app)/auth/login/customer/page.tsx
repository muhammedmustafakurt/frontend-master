...
import {loginCustomer, verifySession} from "@/app/(app)/actions/auth";
import {useRouter} from "next/navigation";
import Link from "next/link";

export default function CustomerLoginPage() {
    const [state, formAction, isPending] = useActionState(loginCustomer, {
        message: "",
        type: "",
    });
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-indigo-950 to-gray-900 flex items-center justify-center px-4 py-12 relative overflow-hidden">
            ...
            <div className="w-full max-w-md relative z-10 animate-fadeIn">
                ...
                <div className="text-center mb-8 animate-slideDown">
                    ...
                    <p className="text-gray-400 text-sm">Hesabınıza güvenli giriş yapın</p>
                </div>
                    ...
                    <form action={formAction} method="POST" className="space-y-6">
                        ...
                        <div className="group">
                            <div className="flex items-center justify-between mb-2">
                                <label htmlFor="password" className="block text-sm font-medium text-gray-300 group-focus-within:text-indigo-400 transition-colors">
                                    Şifre
                                </label>
